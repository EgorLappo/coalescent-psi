...
print(
    f"median epsi: {epsi_boots.median()} ({epsi_boots.quantile(0.025)}, {epsi_boots.quantile(0.975)})"
)
print(
    f"median vpsi: {vpsi_boots.median()} ({vpsi_boots.quantile(0.025)}, {vpsi_boots.quantile(0.975)})"
)
